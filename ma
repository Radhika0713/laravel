...
<hr>
  ...
  <div class="w3-display-container w3-container">
    <img src="head3.jpg" alt="Jeans" style="width:100%">
  ...
  <div class="w3-row w3-grayscale">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        ...
        <p>Watch+Belt+Sunglasses<br><b>Rs.2999</b></p>
      </div>
...
<p>Belt <br><b>Rs.499</b></p>
      </div>
      <div class="w3-container">
        <img src="a4.jpg" style="width:100%">
        <p>DIOR Exclusive<br><b>Rs.4999</b></p>
      </div>
    </div>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        ...
        <p>APPLE Smart Watch<br><b>Rs.29999</b></p>
      </div>
      <div class="w3-container">
        <div class="w3-display-container">
          <img src="a6.jpg" style="width:100%">
        </div>
        <p>ASUS Zenwatch<br><b class="w3-text-red">Rs.24999</b></p>
      </div>
    </div>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        ...
        <p>FCB Metal Ring<br><b>Rs.999</b></p>
      </div>
      <div class="w3-container">
        <img src="a8.jpg" style="width:100%">
        <p>SHINE Special Perfumes<br><b>Rs.1499</b></p>
      </div>
    </div>
  </div>
