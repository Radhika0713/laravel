  ...
  <div class="w3-row w3-grayscale">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        ...
        <p>SHINE Casuals<br><b>Rs.1499</b></p>
      </div>

      <div class="w3-container">
        <img src="s2.jpg" style="width:100%">
        <p>PUMA Ferrari Edition<br><b>Rs.5999</b></p>
      </div>
    </div>
...
<p>NIKE Sports<br><b>Rs.2999</b></p>
      </div>
      <div class="w3-container">
        <img src="s4.jpg" style="width:100%">
        <p>Addidas White <br><b>Rs.3499</b></p>
      </div>
    </div>

    <div class="w3-col l3 s6">
      <div class="w3-container">
        <img src="s5.png" style="width:100%">
        <p>Black Formal<br><b>Rs.1999</b></p>
      </div>
      <div class="w3-container">
        <div class="w3-display-container">
          <img src="s6.jpg" style="width:100%">
        </div>
        <p>Maroon Long Boots<br><b class="w3-text-red">Rs.2499</b></p>
      </div>
    </div>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        ...
        <p>Brown Formal (Shine)<br><b>Rs.2499</b></p>
      </div>
      <div class="w3-container">
        <img src="s8.jpg" style="width:100%">
        <p>PUMA Sneakers <br><b>Rs.3499</b></p>
      </div>
    </div>
  </div>
